...
<html>
 ...
 $sql = "INSERT INTO contactform (first_name, last_name, email, comments)
 VALUES ('".$_POST["first_name"]."','".$_POST["last_name"]."','".$_POST["email"]."','".$_POST["comments"]."')";
 
 if ($link->query($sql) === TRUE) {
  echo "<h4>Submission received, returning to home page.</h4>";
  } else {
